...
ehr_data_dir = '../mimic4extract/data/phenotyping'  # Changed from data/mimic-iv-extracted/phenotyping

cxr_data_dir = '/srv/local/data/MIMIC-CXR'  # Changed from data/physionet.org/files/mimic-cxr-jpg/2.0.0
