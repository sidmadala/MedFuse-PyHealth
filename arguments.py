...
def args_parser():
    ...
    parser.add_argument('--epochs', type=int, default=15,  # Changed from 100
    ...
    parser.add_argument('--batch_size', type=int, default=32)  # Changed from 64
    ...
    parser.add_argument('--ehr_data_dir', type=str, help='Path to the data of phenotyping fusion_type',
                        default='mimic4extract/data')  # Changed from data/mimic-iv-extracted
    parser.add_argument('--cxr_data_dir', type=str, help='Path to the data of phenotyping fusion_type',
                        default='/srv/local/data/MIMIC-CXR')  # Changed path from data/physionet.org/files/mimic-cxr-jpg/2.0.0
