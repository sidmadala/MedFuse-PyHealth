...
# NOTE: Changed from core to hosp for v2 of mimic-iv
...
phenotypes = add_hcup_ccs_2015_groups(diagnoses, yaml.safe_load(open(f'{args.phenotype_definitions}', 'r')))  # NOTE: Changed to safe load
